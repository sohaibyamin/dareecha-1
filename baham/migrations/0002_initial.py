    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(choices=[('Bin Qasim', 'Bin Qasim'), ('Gadap', 'Gadap'), ('Gulberg', 'Gulberg'), ('Jamshed', 'Jamshed'), ('Keamari', 'Keamari'), ('Korangi', 'Korangi'), ('Landhi', 'Landhi'), ('Liaquatabad', 'Liaquatabad'), ('Malir', 'Malir'), ('New Karachi', 'New Karachi'), ('North Nazimabad', 'North Nazimabad'), ('Orangi', 'Orangi'), ('SITE', 'SITE'), ('Saddar', 'Saddar'), ('Shah Faisal', 'Shah Faisal'), ('Gulshan-e-Iqbal', 'Gulshan-e-Iqbal'), ('Liaquatabad', 'Liaquatabad')], max_length=50)),
                ('date_created', models.DateField(verbose_name=models.DateTimeField(default=django.utils.timezone.now, editable=False))),
                ('active', models.BooleanField(default=True, editable=False)),
                ('date_deactivated', models.DateField(verbose_name=models.DateTimeField(editable=False))),
